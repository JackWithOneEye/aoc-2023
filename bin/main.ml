...
let day_subrouters =
  ...
  ; (module Day_14.Problem)
  ; (module Day_15.Problem)
  ; (module Day_16.Problem)
  ; (module Day_17.Problem)
  ; (module Day_18.Problem)
  ; (module Day_19.Problem)
  ; (module Day_20.Problem)
  ; (module Day_21.Problem)
  ]
